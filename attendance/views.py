    ...
    def post(self, request, *args, **kwargs):
        ...
        if push_type == 'attendance' and not is_attendanced: # 出勤ボタンが押された時かつ今日の出勤データがない場合
            ...
            if is_attendanced:
                ...
                attendance.leave_time = datetime.now()  #【モデル】.【カラム名】=【値】 でModelに値を挿入
                attendance.save()
...
class AttendanceRecords(LoginRequiredMixin, TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        for attendance in month_attandances:
            ...
            leave_time = attendance.leave_time #【モデル】.【カラム名】=【値】 でModelに値を挿入
            if leave_time:
            ...
            attendances_context.append(day_attendance) # 辞書型day_attendanceをattendances_contextに追加
        
        context = {'attendances': attendances_context} # 辞書型attendances_contextをcontextに追加
